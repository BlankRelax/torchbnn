...
#     ro.find_outliers(sd=10)
# ro.write_new('H:\\Datasets\\','UK-HPI-full-file-2022-01_clean.csv')
...
###################################PART 5################################## plot new data
df=functions.read_data('H:\\Datasets\\','UK-HPI-full-file-2022-01_clean.csv')
columns=functions.get_columns(df)
functions.plot_scat(df, columns, 'AveragePrice', (3,3))
functions.make_hist(df,columns,(3,3))